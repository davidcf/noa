...
if( isset($_POST['submit_data']) ){
	...
	// Here $db comes from "db_connection.php"
        ...
        if( $db->exec($query) ){
		$message = '<div class="alert alert-success"><strong>Info!</strong> Action is inserted successfully.</div>';
	}else{
		$message = '<div class="alert alert-danger"><strong>Danger!</strong> Sorry, Action is not inserted.</div>';
	}
}
?>
<!DOCTYPE html>
      ...
      <div><?php echo $message;?></div>
        ...
        <form action="add-action.php" method="post">
          ...
          <div class="form-group">
            ...
            <small id="label4help" class="form-text text-muted">action</small>
          </div>
          <div class="form-group">
            <label>Answer</label>
          ...
          <input class="btn btn-primary" name="submit_data" type="submit" value="Add Action">
        </form>
            </div>
